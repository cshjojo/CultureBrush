...
if (os.hostname().includes('15.164.104.197') || os.hostname().includes('172.30.1.39') || os.hostname() === 'localhost') {
  ...
  Vue.prototype.$api_url = 'http://13.209.125.186/'
  Vue.prototype.$socket_url = 'ws://13.209.125.186:8000/'
  Vue.prototype.$media_url = 'http://13.209.125.186/media/'
  ...
  Vue.prototype.$socket_url = 'ws://127.0.0.1:8000/'
  Vue.prototype.$media_url = 'http://127.0.0.1:8000/media/'
}
// else {
//   console.log("@@@@@@@@@@@@@@SERVER@@@@@@@@@@@@@@@")
//   // 본서버
